package com.tencent.fge.engine.ui.keyboard
{
	...
	public class KeyCode
	{
		...
		public static function keyCode2Name(keyCode:uint):String
		{
			if(ms_mapCode2Name == null)
			{
				ms_mapCode2Name = mapKeyCode2Name();
			}
			return ms_mapCode2Name[keyCode];
		}
		
		public static function keyName2Code(keyName:String):uint
		{
			if(ms_mapName2Code == null)
			{
				ms_mapName2Code = mapKeyName2Code();
			}
			return ms_mapName2Code[keyName];
		}
		...
		{
			const LIST_CHAR:String = "abcdefghijklmnopqrstuvwxyz";
			const LIST_NUM:String = "1234567890";
			var map:Dictionary = new Dictionary;
			var i:int;
			for(i = 0; i < LIST_CHAR.length; ++i)
			{
				var c1:String = LIST_CHAR.charAt(i);
				var c2:String = c1.toLocaleUpperCase();
				map[KeyCode[c2]] = c1;
			}
			
			for(i = 0; i < LIST_NUM.length; ++i)
			{
				var c:String = LIST_NUM.charAt(i);
				map[KeyCode["NUMBER_"+c]] = c;
				map[KeyCode["NUMPAD_"+c]] = c;
			}
