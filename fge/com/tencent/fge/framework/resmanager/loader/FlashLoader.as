package com.tencent.fge.framework.resmanager.loader
{
	...
	final internal class FlashLoader extends Loader implements IAtomLoader
	{
		...
		public function FlashLoader(md5:String)
		{
			super();
			m_md5 = md5;
		}
		...
		override public function unload():void
		{
			...
			{
				Log.error("FlashLoader.unload", e.errorID, e.toString());
			}
