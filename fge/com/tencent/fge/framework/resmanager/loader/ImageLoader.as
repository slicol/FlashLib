package com.tencent.fge.framework.resmanager.loader
{
	...
	final internal class ImageLoader extends Loader implements IAtomLoader
	{
		...
		public function get value():*
		{
			...
			{
				return Bitmap(this.content).bitmapData;
			}
			else
			{
				return null;
		...
		override public function unload():void
		{
			...
			{
				Log.error("ImageLoader.unload", e.errorID, e.toString());
			}
