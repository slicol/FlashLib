package yellmer.engine.ps
{
	...
	public class ParticleSystem
	{
		...
		public function Render():void
		{
			...
			info.sprite.RenderBundled(function():void
			{
				for(i = 0; i < m_nParticlesAlive; ++i)
				{
					...
					info.sprite.Render(par.vecLocation.x * m_fScale + m_fTx, par.vecLocation.y * m_fScale + fTy, par.fSpin * par.fAge, par.fSize * m_fScale);
